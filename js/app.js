/* TODO: fix import data */
//import apps from "data/apps.json"
//import icons from "data/svg-icons.json"
...
new Vue({
    ...
    data: {
        ...
        mail: {
            id: 1, title: "Mail", class: "", width: 36, height: 36, paths: [
        ...
        android: {
            id: 2, title: "Android App", class: "tag-icon", width: 24, height: 24, paths: [
        ...
        ios: {
            id: 3, title: "IOS App", class: "tag-icon", width: 24, height: 24, paths: [
        ...
        flutter: {
            id: 4, title: "Flutter App", class: "tag-icon", width: 24, height: 24, paths: [
        ...
        kotlin: {
            id: 5, title: "Coded in Kotlin", class: "tag-icon", width: 24, height: 24, paths: [
    ...
    mounted() {
        ...
        this.mail = icons.mail;
        this.android = icons.android;
        this.ios = icons.ios;
        this.flutter = icons.flutter;
        this.kotlin = icons.kotlin; */
    }
})